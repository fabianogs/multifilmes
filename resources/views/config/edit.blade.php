            ...
            <div class="col-md-12">
                <div class="card card-secondary">
                    <div class="card-header">
                        <h3 class="card-title">Dados do site da unidade: {{ $unidade->cidade }}</h3>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="tel" name="celular" id="celular" class="form-control" value="{{$config->celular}}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="tel" name="fone1" id="fone1" class="form-control" value="{{$config->fone1}}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="tel" name="fone2" id="fone2" class="form-control" value="{{$config->fone2}}">
                                    </div>
                                </div>
                                <div class="col-lg-6">
